      ...
      <div className="dash-wrap">
        ...
        <div className="stats-grid">
          <div className="stat-card">
            ...
            <div className="stat-desc">Signed up</div>
          </div>
          <div className="stat-card">
          ...
          <div className="stat-card">
            ...
            <div className="stat-desc">Need setup</div>
          </div>
          <div className="stat-card">
        ...
        <div className="clients-table">
          {loading ? (
            ...
            <div className="empty-state">
              ...
              <p>Share your onboarding link with Ben to get your first client.</p>
              <a href="/onboarding" className="btn-add">+ Add first client</a>
            </div>
          ) : (
            <>
              ...
              {clients.map((client) => (
                <div key={client.id} className="table-row">
                  ...
                  <div className="table-cell">{client.receptionist_name || "—"}</div>
